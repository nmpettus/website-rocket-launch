...
export const bookSEOData = {
  creation: {
    ...
    keywords: [
      ...
      "creation book for kids",
      "bible stories for toddlers",
      "religious picture books",
      "God's creation children's book",
      "multilingual bible stories",
  ...
  jonah: {
    ...
    keywords: [
      ...
      "bible stories for kids",
      "jonah children's bible",
      "whale story for children",
      "christian picture books",
      "bible adventures kids",
      "religious stories for children",
      "obedience stories for kids",
  ...
  "gods-love": {
    ...
    keywords: [
      ...
      "children's bible stories",
      "god's love picture book",
      "religious books for children",
      "faith stories for kids",
      "christian picture books",
      "god's care children's book",
...
export const homeSEOData = {
  ...
  keywords: [
    ...
    "bible stories for kids",
    "religious picture books",
    "christian literature children",
    "bible adventures kids",
    "maggie bible stories",
    "children's christian education",
    "faith books for children",
    "biblical stories toddlers",
    "christian picture books",
    "religious education kids",
    "bible story collection children",
