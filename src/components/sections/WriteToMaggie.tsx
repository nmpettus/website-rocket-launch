...
const WriteToMaggie = () => (
  <section id="write-to-maggie" className="py-16 bg-rose-light scroll-mt-20">
    <div className="container mx-auto px-2 max-w-md">
      <h2 className="text-4xl font-extrabold text-center mb-2 text-primary font-display">
        Write to Maggie
      </h2>
      <p className="text-center text-secondary max-w-md mx-auto mb-1 text-sm">
