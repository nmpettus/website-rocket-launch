...
// - Heading now matches other section titles: text-5xl mb-2 (updated to text-6xl)

const WriteToMaggie = () => (
  <section id="write-to-maggie" className="py-4 bg-pink-50">
    <div className="container mx-auto px-2 max-w-md">
      <h2 className="text-6xl font-extrabold text-center mb-2 text-purple-700 font-['Comic_Neue']">
        Write to Maggie
      </h2>
