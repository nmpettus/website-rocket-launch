    ...
    <section id="projects" className="py-16 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Project 2 - AI Adventures with Maggie */}
          <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition duration-300">
            <div className="bg-pink-500 bg-opacity-10 text-pink-500 w-12 h-12 rounded-full flex items-center justify-center mb-4">
            ...
            <p className="text-gray-600 mb-4">A fun, simple introduction to artificial intelligence for kids, explained by Maggie! Expected release: Sept 2025.</p>
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div className="bg-pink-500 h-2.5 rounded-full" style={{width: "30%"}}></div>
            </div>
