  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-12">
      <div className="flex justify-center">
          ...
          alt="Maggie the dog" 
          className="rounded-full h-64 w-64 object-cover border-4 border-card-foreground shadow-lg" 
        />
      </div>
      <div className="lg:col-span-2 space-y-4">
        <h3 className="text-2xl font-bold text-foreground">The Voice Behind the Stories</h3>
